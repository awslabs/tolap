 ...
 * cluster. The ceiling is `LEAST({DBInstanceClassMemory/9531392}, 5000)` from the default
 * `aurora-postgresql16` parameter group, and Serverless v2 gives 2 GiB per ACU -- so 112
 * at the 0.5 ACU floor this cluster starts from, verified against the deployed cluster
 * rather than estimated. An unbounded pool therefore trades a latency problem for connection
